...
public class Tickets extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = (Button)findViewById(R.id.buttonCallDialogTicket);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new CustomDialogTickets(v.getContext(), Tickets.this, null);
            }
        });
    }
    ...
    void refresh_screen() {
        new GetRowsTickets(this).execute();
    }
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case MENU_CONTEXT_DELETE_ID: { // видалення елемента з бази даних
                ...
                databaseConnector.deleteTableRowTicket(_id);
            ...
            case MENU_CONTEXT_EDIT_ID: { // редагування елемента
                ...
                new CustomDialogTickets(this, this, _id);
